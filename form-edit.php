...
<head>
  <title>Formulir Ubah Data Siswa</title>
</head>

<body>
  <header>
    <h3>Formulir Ubah Data Siswa</h3>
  </header>
  ...
  <form action="proses-edit.php" method="POST">
    ...
    <fieldset>
      ...
      <p>
        ...
        <input type="text" name="nama" placeholder="nama lengkap" value="<?php echo $siswa['id'] ?>">
      </p>

      <p>
        <label for="alamat">Alamat: </label>
        <textarea name="alamat"><?php echo $siswa['id'] ?></textarea>
      </p>
